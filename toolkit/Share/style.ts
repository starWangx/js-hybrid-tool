export default {
  ...
  .m-share-qq {
    ...
    transform: scale(0.5);
    margin-left: -9%;
    background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -10px -10px;
}
...
.m-share-qzone {
    ...
    flex-shrink: 0;
    margin-left: -9%;
    background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -110px -10px;
}
...
.m-share-copylink {
    ...
    flex-shrink: 0;
    margin-left: -9%;
    background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -210px -10px;
}
...
.m-share-wxline {
    ...
    flex-shrink: 0;
    margin-left: -9%;
    background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -10px -146px;
}
...
.m-share-wx {
  ...
  transform: scale(0.5);
  flex-shrink: 0;
  background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -210px -146px;
}
.m-share-sina {
    transform: scale(0.5);
    width: 80px; height: 116px;
    flex-shrink: 0;
    margin-left: -9%;
    background: url('https://w1.hoopchina.com.cn/images/share/share_sp.png') -110px -146px;
}
